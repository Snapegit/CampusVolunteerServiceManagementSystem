				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="积分" prop="jifen">
							<el-input class="list_inp" v-model="form.jifen" placeholder="积分"
								 type="text" 								:readonly="!isAdd||disabledForm.jifen?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="理由" prop="liyou">
							<el-input v-model="form.liyou" placeholder="理由" type="textarea"
							:readonly="!isAdd||disabledForm.liyou?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='liyou'){
					form.value.liyou = row[x];
					disabledForm.value.liyou = true;
					continue;
				}
				if(x=='riqi'){
			...
			form.value.jifen = 0
			disabledForm.value.jifen = false;
			form.value.sfsh='待审核'
			formVisible.value = true
		}
	...
	const save=()=>{
		...
		if(objcross!='') {
			objcross.jifen = objcross.jifen - form.value.jifen
			if(objcross.jifen<0){
				context?.$toolUtil.message('积分不足','error')
				return false
			}
		}
		let crossUserId = ''
