				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="活动编号" prop="huodongbianhao">
							<el-input class="list_inp" v-model="form.huodongbianhao" placeholder="活动编号"
								 type="text" 								:readonly="!isAdd||disabledForm.huodongbianhao?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="12">
						<el-form-item label="活动人数" prop="huodongrenshu">
							<el-input class="list_inp" v-model.number="form.huodongrenshu" placeholder="活动人数"
								 type="text" 								:readonly="!isAdd||disabledForm.huodongrenshu?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="12">
						<el-form-item label="活动条件" prop="huodongtiaojian">
							<el-input class="list_inp" v-model="form.huodongtiaojian" placeholder="活动条件"
								 type="text" 								:readonly="!isAdd||disabledForm.huodongtiaojian?true:false" />
						</el-form-item>
					</el-col>
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='huodongrenshu'){
					form.value.huodongrenshu = row[x];
					disabledForm.value.huodongrenshu = true;
					continue;
				}
				if(x=='huodongtiaojian'){
					form.value.huodongtiaojian = row[x];
					disabledForm.value.huodongtiaojian = true;
					continue;
				}
				if(x=='huodongshijian'){
			...
			form.value.huodongrenshu = 0
			disabledForm.value.huodongrenshu = false;
			formVisible.value = true
		}
	...
	const save=()=>{
		...
		if(!!objcross) {
			objcross.huodongrenshu = parseFloat(objcross.huodongrenshu) + parseFloat(form.value.huodongrenshu)
		}
		let crossUserId = ''
		let crossRefId = ''
		let crossOptNum = ''
