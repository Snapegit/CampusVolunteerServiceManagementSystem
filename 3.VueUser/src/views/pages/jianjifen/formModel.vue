		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					...
					<div  class="info_text" >{{detail.jifen}}</div>
				</div>
				<div class="info_item">
					<div class="info_label">理由</div>
					<div  class="info_text" >{{detail.liyou}}</div>
				</div>
				<div class="info_item">
				...
				<div class="btn_view">
					<el-button class="approval_btn" v-if="btnAuth('jianjifen','审核')" type="warning" @click="approvalClick()">审核</el-button>
					<el-button v-if="centerType&&(detail.ispay=='未支付'||!detail.ispay)&&btnFrontAuth('jianjifen','支付')" class="approval_btn" @click="payClick">支付</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jianjifen','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jianjifen','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
